#!/usr/bin/env bash
# =============================================================================
# deploy/local/run.sh — Start the full local URL shortener dev stack
# =============================================================================
# Canonical local entrypoint. The historical /run-local.sh file is kept as a
# compatibility wrapper and delegates here.
# =============================================================================
set -euo pipefail
...
usage() {
  cat <<'EOF'
Usage: ./deploy/local/run.sh [options]
...
print_summary() {
  ...
  echo -e "    ${YELLOW}./deploy/local/stop.sh${NC}"
  echo ""
}
